...
auto yyjson_minimal_test(bool diagnostics_mode = false, bool debug_mode = false) -> void;
...
auto write_summary_json(const std::vector<SummaryResult>& summary_results,
                        const std::string& filename, bool diagnostics_mode = false,
                        bool debug_mode = false) -> void;
auto load_summary_results(const std::vector<std::string>& files, bool diagnostics_mode = false,
                          bool debug_mode = false) -> std::vector<SummaryResult>;
