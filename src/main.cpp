...
auto main(int argc, char* argv[]) -> int
{
  ...
  if (args.summary_table)
  {
    ...
    auto summary_results =
        load_summary_results(args.summary_files, args.diagnostics_mode, args.debug_mode);
    print_summary_table(summary_results);
    std::string summary_path = std::string("results/") + SUMMARY_JSON_FILENAME;
    write_summary_json(summary_results, summary_path, args.diagnostics_mode, args.debug_mode);
