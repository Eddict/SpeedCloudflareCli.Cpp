...
inline constexpr const char *BUILD_VERSION = __DATE__ " " __TIME__;
inline constexpr const char *SUMMARY_JSON_FILENAME = "summary.json";
...
struct TestResults {
  ...
  int cpu_cores = 0;
  std::vector<double> latency, download_100kB, download_1MB, download_10MB,
      download_25MB, download_100MB;
